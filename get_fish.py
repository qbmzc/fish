...
if __name__ == '__main__':
    ...
    print("./Data/03/result_" + img_name)
    cv2.imwrite("./Data/03/result_" + img_name, result)
    cv2.imwrite("./Data/03/blur_" + img_name, blur)
    cv2.imwrite("./Data/03/draw_image_" + img_name, draw_img)
    cv2.imwrite("./Data/03/input_" + img_name, src)
